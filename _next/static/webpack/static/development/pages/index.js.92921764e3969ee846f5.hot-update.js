...
function (_React$Component) {
  ...
  function Menu(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "authenticate", function (provider) {
      var authProvider = new firebase_app__WEBPACK_IMPORTED_MODULE_12___default.a.auth["".concat(provider, "AuthProvider")]();
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              scores.on("value", function (data) {
                if (!data || !data.val() || !data.val()[user.uid]) myScores.set({
                  score: 1000,
                  email: user.email,
                  displayName: user.displayName,
                  photo: user.photoURL
                ...
                _this.setState({
                  score: data ? data.val() ? data.val()[user.uid].score : 1000 : 1000
                });
              }, function (error) {
                console.log(error);
              });
      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(firebase_app__WEBPACK_IMPORTED_MODULE_12___default.a.auth().signOut());
      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              user = firebase_app__WEBPACK_IMPORTED_MODULE_12___default.a.auth().currentUser;
              ...
              authProvider = new firebase_app__WEBPACK_IMPORTED_MODULE_12___default.a.auth["".concat(provider, "AuthProvider")]();
              _context3.next = 5;
              return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(_base__WEBPACK_IMPORTED_MODULE_13__["default"].auth().signInWithPopup(authProvider).then(function (authData) {
                _this.state.myScoresRef.remove(function () {
                  firebase_app__WEBPACK_IMPORTED_MODULE_12___default.a.auth().currentUser["delete"]().then(function () {
                    _this.setState({
                      email: null,
                      displayName: null,
                      route: "Home"
...
//# sourceMappingURL=index.js.92921764e3969ee846f5.hot-update.js.map