          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              scores.on("value", function (data) {
                console.log("scores ===>", data.val(), data.val()[user.uid].score);

                _this.setState({
                  score: data.val() ? data.val()[user.uid].score : 1000
                });
              }, function (error) {
                console.log(error);
              });
...
//# sourceMappingURL=index.js.60d77006c5bc98845e3f.hot-update.js.map