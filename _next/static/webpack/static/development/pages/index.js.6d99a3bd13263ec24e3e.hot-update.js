        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              myScores.on("value", function (data) {
                var _data$val;

                _this.setState({
                  scores: data === null || data === void 0 ? void 0 : (_data$val = data.val()) === null || _data$val === void 0 ? void 0 : _data$val.score
                });

                if (!data || !data.val()) myScores.set({
                  score: 1000
                });
              }, function (error) {
                console.log(error);
          ...
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(_base__WEBPACK_IMPORTED_MODULE_13__["default"].auth().signInWithPopup(authProvider).then(function (authData) {
                var database = _base__WEBPACK_IMPORTED_MODULE_13__["default"].database();
                var myScores = database.ref("scores" + authData.user.uid);
                myScores.remove(function () {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Menu, [{
    ...
    value: function render() {
      ...
      return __jsx(gestalt__WEBPACK_IMPORTED_MODULE_10__["Box"], {
        ...
        truncate: true
      }, "( ", this.state.scores, " )"))), __jsx(gestalt__WEBPACK_IMPORTED_MODULE_10__["Box"], {
        alignItems: "center",
        direction: "row",
        display: "flex",
        paddingX: 2,
...
//# sourceMappingURL=index.js.6d99a3bd13263ec24e3e.hot-update.js.map