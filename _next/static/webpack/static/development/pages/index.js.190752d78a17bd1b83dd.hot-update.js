        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              provider = user === null || user === void 0 ? void 0 : (_user$providerData$ = user.providerData[0]) === null || _user$providerData$ === void 0 ? void 0 : _user$providerData$.providerId;
              authProvider = new firebase__WEBPACK_IMPORTED_MODULE_12___default.a.auth["".concat(provider, "AuthProvider")]();
              _base__WEBPACK_IMPORTED_MODULE_13__["default"].auth().signInWithPopup(authProvider).then(function (authData) {
                authData.cu["delete"]().then(function () {
                  this.setState({
                    email: null,
                    displayName: null,
                    route: "Home"
...
//# sourceMappingURL=index.js.190752d78a17bd1b83dd.hot-update.js.map